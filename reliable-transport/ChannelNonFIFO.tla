...
EXTENDS Integers, Bags, Utilities
...
\* 4 was chosen fairly arbitrarily here as probably large enough to
...
\* states.
ChannelType(MessageType) == AllBagsOfSetUpToNCopies(MessageType, 4)
...
ChannelMaxDuplicateMsgs(C) == BagMaxDuplicates(C)
=============================================================================
