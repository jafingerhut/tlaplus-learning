...
This is identical to GBN_fifo, except it EXTENDS ChannelNonFIFO
instead of ChannelFIFO.  Thus the channels from A to B, and from B to
A, can deliver messages in a different order than they were
transmitted.
